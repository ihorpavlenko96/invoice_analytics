...
const InvoiceManagementPage: React.FC = () => {
  ...
  // Handle export to Excel - exports ALL invoices with current filters (status, archived)
  const handleExportToExcel = async () => {
    setIsExporting(true);
    try {
      // Export all invoices (no pagination), but respect status and includeArchived filters
