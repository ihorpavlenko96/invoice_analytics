...
export const invoiceService = {
  ...
  /**
   * Export every invoice of the tenant to an Excel file.
   * Pagination and filters are intentionally not sent — the API returns all
   * invoices, including archived ones.
