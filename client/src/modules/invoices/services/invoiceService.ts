...
export const invoiceService = {
   ...
   * Note: Exports ALL invoices matching the filters, ignoring pagination
   * @param page - Page number (deprecated - kept for API compatibility but ignored on backend)
   * @param limit - Number of items per page (deprecated - kept for API compatibility but ignored on backend)
   * @param status - Optional status filter (PAID, UNPAID, OVERDUE)
