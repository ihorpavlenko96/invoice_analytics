...
export const invoiceService = {
  ...
  /**
   * Export ALL invoices for the current tenant to an Excel file.
   * Ignores pagination and all filters (status, includeArchived, searchQuery) —
   * archived invoices are included. See IA-593.
