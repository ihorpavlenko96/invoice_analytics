...
export class InvoiceController {
    ...
    @ApiOperation({
        ...
        description: 'Exports ALL invoices to an Excel file based on filters (status, includeArchived). Note: Ignores pagination - all matching invoices will be exported.',
    })
    @ApiQuery({
        name: 'status',
        required: false,
