...
export class InvoiceController {
    ...
    @ApiOperation({
        ...
        description:
            'Exports ALL invoices for the current tenant to an Excel file. ' +
            'Pagination, status filters, and archive state are ignored so the ' +
            'download always reflects the complete dataset.',
    })
    @ApiResponse({
        status: HttpStatus.OK,
