...
export class InvoiceController {
    ...
    @ApiOperation({
        ...
        description: 'Exports ALL invoices to an Excel file regardless of pagination and filtering',
    })
    @ApiResponse({
        status: HttpStatus.OK,
    ...
    async exportToExcel(
        ...
        const tenantId = request.tenantId!;
        const buffer = await this.invoiceService.exportAllToExcel(tenantId);
