...
export class InvoiceController {
    ...
    @ApiOperation({
        ...
        description: 'Exports ALL invoices to an Excel file (pagination params are ignored, but status filter is respected)',
    })
    @ApiQuery({
        name: 'page',
        required: false,
        type: Number,
        description: 'Page number (ignored for export - all invoices are exported)',
    })
    @ApiQuery({
        name: 'limit',
        required: false,
        type: Number,
        description: 'Number of items per page (ignored for export - all invoices are exported)',
    })
    @ApiQuery({
        name: 'status',
        required: false,
