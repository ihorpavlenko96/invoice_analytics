...
export class InvoiceController {
    ...
    @ApiOperation({
        ...
        description: 'Exports all invoices for the tenant to an Excel file, regardless of pagination and status filters. Archived invoices are excluded by default.',
    })
    @ApiResponse({
        status: HttpStatus.OK,
