...
export class InvoiceController {
    ...
    @ApiOperation({
        ...
        description: 'Exports all invoices to an Excel file. Supports optional status filtering. Note: pagination parameters (page, limit) are ignored for export - all matching invoices will be exported.',
    })
    @ApiQuery({
        name: 'status',
        required: false,
