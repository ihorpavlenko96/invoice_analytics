...
export class InvoiceService implements IInvoiceService {
    ...
    async exportToExcel(tenantId: string): Promise<Buffer> {
        // Fetch all non-archived invoices for the tenant without any pagination or status filter,
        // so that the exported file always contains the complete invoice set.
