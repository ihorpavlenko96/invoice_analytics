...
export class InvoiceService implements IInvoiceService {
    ...
    /**
     * Export all invoices to Excel without pagination limits
     * This method exports ALL invoices for a tenant, not just the current page
     * @param tenantId - Tenant ID to filter by
     * @returns Promise<Buffer> - Excel file buffer
     */
    async exportAllToExcel(tenantId: string): Promise<Buffer> {
