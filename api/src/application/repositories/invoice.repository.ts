...
export class InvoiceRepository {
    ...
    /**
     * Retrieves all non-archived invoices for a tenant without pagination or filtering.
     * Used exclusively for the export flow to ensure all invoices are included in the export.
     */
